...
function MinimalBackdrop() {
  return (
    <div style={{ position: "absolute", inset: 0, background: bgVar, overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", width: "56%", height: "56%", left: "-12%", top: "-14%", borderRadius: "50%", background: `radial-gradient(circle, ${CYAN}38, transparent 72%)`, filter: "blur(50px)", animation: "mh-geo-drift-a 14s ease-in-out infinite" }} />
      <div style={{ position: "absolute", width: "48%", height: "48%", right: "-10%", bottom: "-12%", borderRadius: "50%", background: `radial-gradient(circle, ${AMBER}30, transparent 72%)`, filter: "blur(55px)", animation: "mh-geo-drift-b 18s ease-in-out infinite 1s" }} />
      <div style={{ position: "absolute", width: "62%", aspectRatio: "1 / 1", left: "50%", top: "48%", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.09)", borderTopColor: `${CYAN}44`, animation: "mh-geo-spin-cw 40s linear infinite" }} />
      <div style={{ position: "absolute", width: "38%", aspectRatio: "1 / 1", left: "50%", top: "48%", borderRadius: "50%", border: `1px solid ${CYAN}22`, borderBottomColor: `${AMBER}44`, animation: "mh-geo-spin-ccw 28s linear infinite" }} />
      <div style={{ position: "absolute", width: 46, height: 46, left: "22%", top: "68%", borderRadius: "50%", border: `1.5px solid ${AMBER}55`, animation: "mh-geo-float-1 8s ease-in-out infinite" }} />
      <div style={{ position: "absolute", width: 14, height: 14, left: "78%", top: "24%", borderRadius: "50%", background: `${CYAN}66`, filter: "blur(1px)", animation: "mh-geo-float-2 6.5s ease-in-out infinite 0.4s" }} />
      <div style={{ position: "absolute", width: 26, height: 26, left: "68%", top: "78%", borderRadius: "50%", border: `1.5px solid ${CYAN}44`, animation: "mh-geo-float-3 9.5s ease-in-out infinite 0.8s" }} />
      <div style={{ position: "absolute", width: 8, height: 8, left: "12%", top: "30%", borderRadius: "50%", background: `${AMBER}77`, animation: "mh-geo-float-2 7.5s ease-in-out infinite 1.2s" }} />
    </div>
  )
}
